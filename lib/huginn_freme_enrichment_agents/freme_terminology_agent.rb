module Agents
  class FremeTerminologyAgent < Agent
    ...
    description <<-MD
      ...
      The Agent accepts all configuration options of the `/e-terminology/tilde` endpoint as of September 2016, have a look at the [offical documentation](http://api.freme-project.eu/doc/current/api-doc/full.html#!/e-Terminology/e_terminology) if you need additional information
    ...
    form_configurable :outformat, type: :array, values: ['text/turtle', 'application/ld+json', 'text/n3', 'application/n-triples', 'application/rdf+xml', 'text/html', 'text/xml', 'application/x-xliff+xml']
